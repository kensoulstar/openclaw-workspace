---
name: agent-lifecycle-mgr
description: Agent生命周期管理系统。包含spawn、fork、permission shaping、transcript recording、progress streaming和deterministic cleanup。用于实现或审计agent spawning、resume support、background workers或subagent runtime scaffolding。
---
